let setSliders = function setSliders(sliders, callback, render, gl) {
    ...
    sliders.forEach(function(slider) {
        ...
        sliderValue.textContent = slider.valueCurrent + slider.measurement;
        thumb.style.left = (slider.valueCurrent-slider.valueStart)/(slider.valueEnd - slider.valueStart)*100 + "%";
